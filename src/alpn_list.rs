...
const SEC_APPLICATION_PROTOCOL_LIST_HEADER_SIZE: usize =
    mem::size_of::<u32>() + mem::size_of::<c_ushort>();
const SEC_APPLICATION_PROTOCOL_HEADER_SIZE: usize =
    mem::size_of::<c_ulong>() + SEC_APPLICATION_PROTOCOL_LIST_HEADER_SIZE;
    ...
    pub fn new(protos: &[Vec<u8>]) -> Self {
        ...
        unsafe {
            ...
            protocols.ProtocolListsSize =
                (SEC_APPLICATION_PROTOCOL_LIST_HEADER_SIZE + alpn_wire_format.len()) as c_ulong;
            ...
            protocol.ProtocolListSize = alpn_wire_format.len() as c_ushort;
